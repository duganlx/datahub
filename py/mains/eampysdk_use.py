...
def gsfhelpConf(eamsdk: EamPySdk):
  """
  gsf帮助项目 目录树维护
  """
  data = [
...
def getBardayData(eamsdk: EamPySdk):
  """
  获取A股日k数据
  """
...
def stockTAanalysis(eamsdk: EamPySdk):
  df = eamsdk.getBardayData(
    universe=['600519.SH'], 
    # where='trade_date > \'2023-07-01\''
  )
  ...
  brar = stockTa.brar()
  # todo obv 待验证
  obv = stockTa.obv(offset=0, verbose=True)
...
if __name__ == '__main__':
  eamsdk = EamPySdk()
  # gsfhelpConf(eamsdk)
  # getBardayData(eamsdk)
  stockTAanalysis(eamsdk)
